# Ironsworn Rulebook — Rules

## Stats

## edge

Quickness, agility, and prowess in ranged combat.

## heart

Courage, willpower, empathy, sociability, and loyalty.
...
Sneakiness, deceptiveness, and cunning.

## wits

Expertise, knowledge, and observation.
...
Spirit is your current mental state.
...
You are carrying excessive or cumbersome weight.
...
Cursed is marked when you [Face Death](ironsworn/moves/suffer/face_death) and return with a soul-bound quest. This burden can only be cleared by completing the quest.

### tormented

Tormented is marked when you [Face Desolation](ironsworn/moves/suffer/face_desolation) and undertake a quest to prevent a dire future.
